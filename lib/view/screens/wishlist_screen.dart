                                                                  ...
                                                                  if (Provider.of<OffersProvider>(
                                                                   ...
                                                                   /* Provider.of<OffersProvider>(
                                                                        ...
                                                                        .saveTotalLater(i
                                                                            ...
                                                                            .regularPrice!
                                                                            .toDouble());*/
                                                                     if(i.wishListData[index].installmentPrice != null){
                                                                       Provider.of<OffersProvider>(
                                                                           context,
                                                                           listen:
                                                                           false).set3xInstallmentPrice(i.wishListData[index].installmentPrice!.toDouble());
                                                                       /*Provider.of<OffersProvider>(
                                                                           context,
                                                                           listen:
                                                                           false).setFirstInstallmentPrice(i.wishListData[index].salePrice);*/
                                                                     }
                                                                    /* Provider.of<OffersProvider>(
                                                                         context,
                                                                         listen:
                                                                    ...
                                                                    /* Provider.of<OffersProvider>(
                                                                         context,
                                                                         listen:
                                                                         false).updateInstallmentPrice( i
                                                                         .wishListData[index]
                                                                         .salePrice!
                                                                         .toDouble(), i
                                                                         .wishListData[index]
