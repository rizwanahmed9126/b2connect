        ...
        body: Consumer<OffersProvider>(builder: (context, i, _) {
          return i.cartData.isNotEmpty
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final offerIndex = Provider.of<PayByProvider>(
                                    context,
                                    listen: false)
                                .offerItemsOrder
                                .indexWhere((element) =>
                                    element.offerId ==
                                    i.cartData[index].offer.id);
                                                        ...
                                                        onTap: () {
                                                          ...
                                                          if (i.cartData
                                                            ...
                                                            if (i
                                                              ...
                                                              Provider.of<OffersProvider>(context, listen: false).removeFirstInstallmentPrice((i
                                                                      .cartData[
                                                                          index]
                                                                      .offer
                                                                      .regularPrice *
              ...
              : i.showLoader == null
                  ...
                  : EmptyCart(
                      name:
                          "${AppLocalizations.of(context)!.translate('cart')!}(0)",
                      desc: AppLocalizations.of(context)!
                          .translate('no_items_in_cart')!,
                      showButton: true,
                    );
        }));
  }
