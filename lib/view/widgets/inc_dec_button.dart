  ...
  void add() {
    setState(() {
      ...
      if (widget.categoryId == 54 || widget.categoryId == 118) {
        Provider.of<OffersProvider>(context,listen: false).removeFirstInstallmentPrice(widget.priceLater!.toDouble());
              }
      else{
        Provider.of<OffersProvider>(context,listen: false).removeFirstInstallmentPrice(widget.priceNow!.toDouble());
      }
  ...
  void minus() {
    setState(() {
      if (value != 1) {
        ...
        if (widget.categoryId == 54 || widget.categoryId == 118) {
          Provider.of<OffersProvider>(context,listen: false).delete3xInstallmentPrice(widget.priceLater!.toDouble());
        }
        else{
          Provider.of<OffersProvider>(context,listen: false).removeFirstInstallmentPrice(widget.priceNow!.toDouble());
        }
